...
function text_summary(params, expect_n1, expect_n2, expect_np, N1, N2, Np, Nq, save_dir, filename)
    ...
    κ1  = $(params.k1) | κ2  = $(params.k2) | κϕ  = $(params.kϕ) 
    F = $(params.F) | ωd  = $(params.ωd)
...
function analysis_and_plots(states_cpu_mats, V_mat, t, t_selected, params, expect_n1, expect_n2, expect_np, N1, N2, Np, Nq, save_dir, filename, is_RWA, is_RWA_qubit, numerical_RWA)
    # Calculate Wigner
